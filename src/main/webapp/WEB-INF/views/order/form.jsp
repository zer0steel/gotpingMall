				...
				<table class="table">
					...
					<tbody>
						...
						<tr>
							...
							<td class="name">
								<strong class="goods" style="font-size: 20px;">${d.stock.goods.name }</strong>
				...
				<form class="form-horizontal" action="successCheckout.yo" method="post" id="form-checkout">
					...
					<div class="row">
						...
						<div class="col-md-10 panel panel-default">
							...
							<input type="text" name="name" class="form-control input" data-label="이름" value="${m.name }">
					...
					<div class="row">
						...
						<div class="col-md-10 panel panel-default">
							...
							<div class="form-group">
								...
								<div class="col-md-4">
									<input type="text" id="input-postcode" class="form-control addr" name="addr.postCode" value="${m.address.postCode }" readonly>
								</div>
								<div class="col-md-3">
									<button type="button" id="btn-addrFinder" class="btn btn-info" >찾기</button>
								</div>
							</div>
							<input type="text" class="form-control input addr" name="addr.base" data-label="주소" id="input-addr" value="${m.address.base }" readonly>
							<input type="text" class="form-control input" name="addr.extra" data-label="상세주소" id="input-extraAddr" value="${m.address.extra }">
