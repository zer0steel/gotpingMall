...
function addrFinder() {
    new daum.Postcode({
        oncomplete: function(data) {
            ...
            document.getElementById('input-postcode').value = data.zonecode; //5자리 새우편번호 사용
            document.getElementById('input-addr').value = fullAddr;

            // 커서를 상세주소 필드로 이동한다.
            document.getElementById('input-extraAddr').value = "";
            document.getElementById('input-extraAddr').focus();
        }
    }).open();
}
$(function(){
